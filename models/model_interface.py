...
class DTI_prediction(pl.LightningModule):
    ...
    def step(self, batch):
        mol_feature, prot_feat_student, prot_feat_teacher, text_features, y, source = batch
        prot_feat_teacher = prot_feat_teacher.detach()
        pred, lambda_ = self.model(mol_feature, prot_feat_student, prot_feat_teacher, text_features)
