...
def logging(PROJECT_NAME, lapse_time, seed, results):
    results = [PROJECT_NAME, lapse_time, seed] + results
    
    result_df = pd.DataFrame([results], 
                             columns=["Project", "Lapse_time", "Seed",
    ...
    if os.path.exists("./results/results.csv"):
        ...
        result_df = result_df.sort_values('Project')
